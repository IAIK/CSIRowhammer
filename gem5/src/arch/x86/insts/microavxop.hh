...
protected:
  ...
  // CSI:Rowhammer: Calculate the hash of zmm0 and compare the result to the hash given in zmm1.
  // If they match, set the zero flag to 1
  void CSI_MAC(ExecContext *xc) const;
  // CSI:Rowhammer: Compare two zmm registers, if they match, set the zero flag to 1 
  void CSI_compare(ExecContext *xc) const;
